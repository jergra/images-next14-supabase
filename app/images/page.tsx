		...
		<div className="flex flex-col items-center h-full">
			<div className='flex justify-between w-full bg-gray-100 h-16 items-center py-2 px-10 mb-12'>
				...
				<div className='flex w-1/3 justify-between'>
					<Link href="/"><Button className='bg-gray-500 text-primary-foreground shadow hover:bg-primary/90'>Home</Button></Link>
					<Link href="/images"><Button className='bg-gray-900 text-primary-foreground shadow hover:bg-primary/90'>Profile</Button></Link>
					<form action={logout}>
