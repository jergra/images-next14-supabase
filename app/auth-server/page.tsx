		...
		<div className="flex flex-col items-center h-screen">
			<div className='w-full flex justify-between h-16 items-center py-2 px-10 bg-gray-100'>
				...
				<div className='flex justify-between w-1/3'>
					<Link href="/auth-server"><Button className='bg-primary/10 text-gray-800 shadow hover:bg-primary/10'>Auth Server</Button></Link>
					<Link href="/auth-client"><Button className='bg-white text-gray-800 shadow hover:bg-primary/10'>Auth Client</Button></Link>
